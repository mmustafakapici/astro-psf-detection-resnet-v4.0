...
def save_predictions(image_path, image, output, save_dir):
    ...
    visualize_results(image, output, image_save_path)
...
def main():
    ...
    input_dir = config['inference']['input_dir']  # PNG görüntülerin bulunduğu dizin
    output_dir = config['inference']['output_dir']  # Tahmin sonuçlarının kaydedileceği dizin
    ...
    for image_name in os.listdir(input_dir):
        if image_name.endswith('.png'):
            ...
            save_predictions(image_path, image, output, output_dir)
